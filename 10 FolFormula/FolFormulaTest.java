...
class Tester {
    ...
    private Stream<Term> subterms(Term t) {
        ...
        return Stream.concat(
            ...
            ((FunctionApplication) t)
                .subts()
                .stream()
                .flatMap(subt -> subterms(subt))
        );
    }

    private Stream<Term> aliasedSubterms(Term result, Term original, Term replacement) {
        List<Term> inputSubts =
            Stream.concat(subterms(original),subterms(replacement))
            .collect(Collectors.toList());
        return subterms(result)
            .filter(rt -> inputSubts.stream().anyMatch(it -> it == rt));
    }
    ...
    public void testTermSubst(String desc, Term original, String var, Term replacement, Term expected) {
        ...
        List<Term> aliased = aliasedSubterms(result, original, replacement)
            .distinct().collect(Collectors.toList());
        if (!aliased.isEmpty()) {
            fail("substitute did not create deep copies of the original or replacement term: " + aliased);
        }
    }
...
public class FolFormulaTest {
    ...
    public static void main(String[] args) {
        ...
        t.testCase("TermEquals", s -> {
            ...
            t.compare(F("fff", V("xxx"), V("xxx")).equals(F("fff", V("xxx"))),
                false, "fff(xxx,xxx) != fff(xxx)");
            ...
            t.compare(F("f", C("c"), V("x")).equals(F("f", V("x"), C("c"))),
                false, "f(c,x) != f(x,c)");
            t.compare(F("f", C("xxx"), V("xxx")).equals(F("f", V("xxx"), C("xxx"))),
                false, "f(Const xxx,Var xxx) != f(Var xxx,Const xxx)");
            t.compare(
            ...
            t.compare(V("xxx").equals(null), false, "xxx != null");
            t.compare(C("aaa").equals(null), false, "aaa != null");
            t.compare(F("f", C("c"), V("x")).equals(null), false, "f(c,x) != null");
        });
        ...
        t.testCase("FormulaEquals", s -> {
            ...
            Formula[] unaryFs = {
                ...
                Fa("x", P("p", V("x"))),
                Ex("x", P("p", V("x"))),
                new QuantifiedFormula("∀", "x", P("p", V("x"))),
                new QuantifiedFormula("∃", "x", P("p", V("x")))
            };
            for (Formula f1 : unaryFs) {
                for (Formula f2 : unaryFs) {
                    if (f1.getClass() != f2.getClass()) {
                        t.testNotEqual(f1, f2);
                    }
                }
            }
            ...
            Formula[] binaryFs = {
                ...
                Impl(P("p", V("x")), P("q", C("c"))),
                Eq(P("p", V("x")), P("q", C("c"))),
                new BinaryFormula(P("p", V("x")), P("q", C("c")), "->"),
                new BinaryFormula(P("p", V("x")), P("q", C("c")), "<->")
            };
            for (Formula f1 : binaryFs) {
                for (Formula f2 : binaryFs) {
                    if (f1.getClass() != f2.getClass()) {
                        t.testNotEqual(f1, f2);
                    }
                }
            ...
            t.testNotEqual(P("p", V("x")), null);
            t.testNotEqual(Eq(C("c"), V("x")), null);
            t.testNotEqual(Neg(P("p", V("x"))), null);
            t.testNotEqual(And(P("p", V("x")), P("q", C("c"))), null);
            t.testNotEqual(Or(P("p", V("x")), P("q", C("c"))), null);
            t.testNotEqual(Impl(P("p", V("x")), P("q", C("c"))), null);
            t.testNotEqual(Eq(P("p", V("x")), P("q", C("c"))), null);
            t.testNotEqual(Fa("x", P("p", V("x"))), null);
            t.testNotEqual(Ex("x", P("p", V("x"))), null);
        });
        ...
        t.testCase("FormulaFreeVariables",  new Consumer<Tester.Scope>() {
            ...
            public void accept(Tester.Scope s) {
                ...
                testFree(p(f(f(f(f(f(f(f(V(xn)), f(V(zn), C("c"))))))))), S(xn, zn));

                testFree(Eq(V(xn), f(V(zn), C("c"))), S(xn, zn));
                testFree(Eq(f(f(f(f(f(f(f(V(xn)), f(V(zn), C("c")))))))), f(f(f(f(f(f(f(V(yn))))))))), S(xn, yn, zn));
        ...
        t.testCase("TermSubstitute", s -> {
            ...
            t.testTermSubst("x {x -> y} = y", V("x"), "x", V("y"), V("y"));
            t.testTermSubst("a {x -> x} = a", C("a"), "x", V("x"), C("a"));
            t.testTermSubst("a {x -> x} = a", C("a"), "x", V("x"), C("a"));
            t.testTermSubst("a {a -> b} = a", C("a"), "a", C("b"), C("a"));
            t.testTermSubst("Const a {a -> Var a} = Const a",
                C("a"), "a", V("a"), C("a")
            );
            t.testTermSubst("Const a {a -> a(Var a)} = Const a",
                C("a"), "a", F("a", V("a")), C("a")
            );
            t.testTermSubst("Const a {a -> a(Const a)} = Const a",
                C("a"), "a", F("a", C("a")), C("a")
            );
            ...
            t.testTermSubst("f(y) {y -> g(y)} = f(g(y))",
                F("f", V("y")),
                "y", F("g", V("y")),
                F("f", F("g", V("y")))
            );
            t.testTermSubst("f(y) {y -> f(y)} = f(f(y))",
                F("f", V("y")),
                "y", F("f", V("y")),
                F("f", F("f", V("y")))
            );
            t.testTermSubst("f(y) {f -> c} = f(y)",
                F("f", V("y")),
                "f", C("c"),
                F("f", V("y"))
            );
            t.testTermSubst("f(y) {f -> f(x)} = f(y)",
                F("f", V("y")),
                "f", F("f", V("x")),
                F("f", V("y"))
            );
            ...
            t.testTermSubst("m(c,v,w)" +
                    "{v -> f(x,c1,g(y,h(i(j(u),k(c4),l(v)),z,c3),c2))} = " +
                    "m(c,f(x,c1,g(y,h(i(j(u),k(c4),l(v)),z,c3),c2)),w)",
                F("m", V("w"), V("v"), C("c")),
                "v", bigterm,
                F("m", V("w"), bigterm, C("c"))
            );
        ...
        t.testCase("FormulaSubstitute",  new Consumer<Tester.Scope>() {
            ...
            public void accept(Tester.Scope s) {
                ...
                testSubst(
                    Fa(x, Impl(p(x), p(y))), x, z,
                    Fa(x, Impl(p(x), p(y)))
                );
                testSubst(
                    Fa(x, Impl(p(x), p(y))), y, z,
                    Fa(x, Impl(p(x), p(z)))
                );
                testSubst(
                    Ex(x, Impl(p(x), p(y))), x, z,
                    Ex(x, Impl(p(x), p(y)))
                );
                testSubst(
                    Ex(x, Impl(p(x), p(y))), y, z,
                    Ex(x, Impl(p(x), p(z)))
                );
                testSubst(
                    Fa(x, Impl(p(x), p(y))), x, f(c, z),
                    Fa(x, Impl(p(x), p(y)))
                );
                testSubst(
                    Fa(x, Impl(p(x), p(y))), y, f(c, z),
                    Fa(x, Impl(p(x), p(f(c, z))))
                );
                testSubst(
                    Ex(x, Impl(p(x), p(y))), x, f(c, z),
                    Ex(x, Impl(p(x), p(y)))
                );
                testSubst(
                    Ex(x, Impl(p(x), p(y))), y, f(c, z),
                    Ex(x, Impl(p(x), p(f(c, z))))
                );
                testSubst(
                ...
                testSubst(
                    ...
                    x, g(f(x), z, c),
                    Ex(y, And(
                        p(g(f(g(f(x),z,c)), g(f(x),z,c))),
                        Fa(x, And(p(c), p(x)))
                    ))
                );

                // constant-variable and function-variable confusion
                testSubst(Fa(y, Fa(x, p(c))), V("c"), y, Fa(y, Fa(x, p(c))));
                testSubst(Fa(y, Fa(V("c"), p(x))), x, c, Fa(y, Fa(V("c"), p(c))));
                testSubst(Fa(y, Fa(x, p(f(c)))), V("f"), y, Fa(y, Fa(x, p(f(c)))));
                testSubst(Fa(y, Fa(V("f"), p(x))), x, f(c), Fa(y, Fa(V("f"), p(f(c)))));
            }
        });
